...
const ANGLAIS = {
  ...
  "La CNC — imbrication des contours": "The CNC \u2014 outline nesting",
  ...
  "2 orientations (180°) — rapide": "2 orientations (180°) — fast",
  ...
  "{} fichier(s) téléchargé(s)": "{} file(s) downloaded",
  "{} contour(s) importé(s)\n\n": "{} outline(s) imported\n\n",
  ...
  "Exemple : volets battants": "Example: hinged shutters",
  ...
  "Supprimer": "Delete",
  "Matière…": "Material…",
  "Appliquer une même matière aux lignes choisies": "Apply the same material to the rows selected",
  "Choisissez d'abord une ou plusieurs lignes (clic, Ctrl-clic ou Maj-clic pour en ajouter).": "First select one or more rows (click, Ctrl-click or Shift-click to add to the selection).",
  "Matière à appliquer à {} ligne(s) choisie(s) :": "Material to apply to {} row(s) selected:",
  "Annuler": "Cancel",
  "Appliquer": "Apply",
  ...
  "+ Ajouter": "+ Add",
  "Retirer": "Remove",
  "Renseignez des nombres valides.": "Enter valid numbers.",
  "Recoupe de bout : {} mm à chaque bout": "End trim: {} mm off each end",
  "Recoupe de rive : {} mm à chaque rive": "Edge trim: {} mm off each edge",
  "Nœud traversant de {} à {} mm": "Through knot from {} to {} mm",
  "Zone à ({}, {}) : {} × {} mm": "Area at ({}, {}): {} × {} mm",
  "Longueur à retirer à chaque bout (mm)": "Length to trim off each end (mm)",
  "Largeur à retirer à chaque rive (mm)": "Width to trim off each edge (mm)",
  "De (mm)": "From (mm)",
  "à (mm)": "to (mm)",
  "x depuis le bout gauche (mm)": "x from the left end (mm)",
  "y depuis la rive basse (mm)": "y from the bottom edge (mm)",
  ...
  "Le programme G-code": "The G-code program",
  "Le programme CNC": "The CNC program",
  "Ceux-ci ne changent pas le plan de débit : ils décrivent le fichier G-code qu'on en tire.": "These do not change the cutting plan: they describe the G-code file produced from it.",
  "Chercher un réglage — nom ou explication": "Search a setting \u2014 name or explanation",
  "Dialecte": "Dialect",
